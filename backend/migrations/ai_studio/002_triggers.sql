SET search_path TO ai_studio, public;

CREATE OR REPLACE FUNCTION ai_studio.increment_diffusion_attempt_count()
RETURNS TRIGGER LANGUAGE plpgsql AS $$
BEGIN
    UPDATE ai_studio.ai_assets
...
CREATE OR REPLACE FUNCTION ai_studio.decrement_diffusion_attempt_count()
RETURNS TRIGGER LANGUAGE plpgsql AS $$
BEGIN
    UPDATE ai_studio.ai_assets
...
CREATE OR REPLACE FUNCTION ai_studio.increment_diffusion_completed_count()
RETURNS TRIGGER LANGUAGE plpgsql AS $$
BEGIN
    UPDATE ai_studio.ai_assets
...
CREATE OR REPLACE FUNCTION ai_studio.decrement_diffusion_completed_count()
RETURNS TRIGGER LANGUAGE plpgsql AS $$
BEGIN
    UPDATE ai_studio.ai_assets
...
CREATE OR REPLACE FUNCTION ai_studio.increment_qa_helpful_count()
RETURNS TRIGGER LANGUAGE plpgsql AS $$
BEGIN
    UPDATE ai_studio.ai_asset_qa_posts
...
CREATE OR REPLACE FUNCTION ai_studio.decrement_qa_helpful_count()
RETURNS TRIGGER LANGUAGE plpgsql AS $$
BEGIN
    UPDATE ai_studio.ai_asset_qa_posts
...
FOR EACH ROW EXECUTE FUNCTION ai_studio.increment_diffusion_attempt_count();
...
FOR EACH ROW EXECUTE FUNCTION ai_studio.decrement_diffusion_attempt_count();
...
FOR EACH ROW EXECUTE FUNCTION ai_studio.increment_diffusion_completed_count();
...
FOR EACH ROW EXECUTE FUNCTION ai_studio.decrement_diffusion_completed_count();
...
FOR EACH ROW EXECUTE FUNCTION ai_studio.increment_qa_helpful_count();
...
FOR EACH ROW EXECUTE FUNCTION ai_studio.decrement_qa_helpful_count();
