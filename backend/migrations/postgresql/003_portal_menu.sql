...
VALUES
    ('U_AI_STUDIO', 'AI STUDIO', '과제를 발굴하고 완성된 AI 자산을 등록·탐색·확산합니다.', '/aistudio', NULL, 100, TRUE, 1),
...
INSERT INTO tb_menu
    (menu_id, menu_name, menu_desc, menu_path, parent_menu_id, order_num, menu_visible, menu_depth)
VALUES
    ('U_AI_STUDIO_INTRO', '소개', 'AI STUDIO의 역할과 운영 현황', '/aistudio', 'U_AI_STUDIO_SERVICE', 110, TRUE, 3),
    ('U_AI_STUDIO_DX', 'DX 과제 발굴', 'Agent와 대화하며 업무 과제 구체화', '/aistudio/dx-discovery', 'U_AI_STUDIO_SERVICE', 120, TRUE, 3),
    ('U_AI_STUDIO_ASSETS', 'AI 자산 라이브러리', '검증된 자산 탐색과 현업 확산', '/aistudio/assets', 'U_AI_STUDIO_SERVICE', 130, TRUE, 3),
