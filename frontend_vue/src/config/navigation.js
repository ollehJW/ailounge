export const NAV_SECTIONS = [
  {
    ...
    items: [
      { to: "/aistudio/intro", eyebrow: "OVERVIEW", label: "소개", description: "AI STUDIO의 역할과 운영 현황" },
      { to: "/aistudio/dx-discovery", eyebrow: "DEFINE", label: "DX 과제 발굴", description: "Agent와 대화하며 업무 과제 구체화" },
      { to: "/aistudio/assets/explore", eyebrow: "REUSE", label: "AI 자산 탐색", description: "검증된 자산 탐색과 현업 확산" },
