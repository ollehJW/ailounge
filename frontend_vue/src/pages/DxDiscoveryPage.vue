      ...
      <div class="dx-workspace">
        ...
        <section class="dx-chat-panel">
          ...
          <form @submit.prevent="sendMessage">
            ...
            ></textarea>
            <button class="primary-button" :disabled="typing||!input.trim()" aria-label="전송"><Send :size="17" /></button>
          </form>
        </section>
      </div>
...
const sessions=ref([]),detail=ref(null),activeId=ref(""),input=ref(""),inputHasOverflow=ref(false),loading=ref(true),typing=ref(false),error=ref(""),chatBody=ref(null);
